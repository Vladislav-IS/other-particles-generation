# Физически информированная генеративная модель для симуляции столкновений тяжелых ядер (модель Pion-GAN)

Репозиторий исследовательского проекта, не является приложением\сервисом.
